 ...
 * @author ptd
 */
@WebServlet(name = "UpdateStuffServlet", urlPatterns = {"/UpdateStuffServlet"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (!isQuantityPositive) {
                ...
                Stuff stuff = new Stuff(stuffId, description, Float.parseFloat(price), "", 0, Integer.parseInt(quantity), NotSale, "");
                boolean result = dao.updateStuff(stuff);
                if (result) {
            ...
            log("UPDATESTUFFSERVLET + SQLEXCEPTION: " + ex.getMessage());
        } finally {
