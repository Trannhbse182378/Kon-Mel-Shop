    ...
    <head>
        ...
        <style>
            ...
            *{
            ...
            .btn-user:hover, .btn-order:hover{
                border: white solid 2px;
                color: #44709d;
                background-color: white;
            }
        ...
        <div class="header-container">
            <div class="luxury-form-container">
                <form action="MainController" method="GET" class="luxury-form" style="position: absolute; top: 19px; left: 73px;">
                    <input type="hidden" name="action" value="SearchAndRedirectStaff">
                    <div style="position: relative;">
                        ...
                        <input type="text" name="searchStuff" placeholder="Search by name" class="luxury-input" style="padding-left: 40px;">
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 manage">
                                <form action="MainController" method="get">
                                    <input type="hidden">
                                    <h2><button class="btn-stuff" type="button"> STUFF</button> 
                                        <button name="action" value="ViewUsers" class="btn-user" type="submit" href="staffUser.jsp"> USER</button>
                                        <button name="action" value="ViewOrder" class="btn-order" type="submit">ORDER</button>
                                    </h2>
                                </form>
                            </div>
                            <div class="col-sm-6" style="margin-top: 3px;">
                                <a style="color: #44709d;" href="#addEmployeeModal" class="btn btn-addstuff" data-toggle="modal"><i class="material-icons" style="margin-top: 2px;">&#xE147;</i> <span>Add New Stuff</span></a>
                            </div>
                        </div>
                    </div>
                    <table class="table table-striped table-hover">
                        <thead>
                            <tr class="tr" style="text-align: center;">
                                ...
                                <th style="width: 50px;">Production Year</th>
                                <th style="width: 50px;">Quantity</th>
                                <th style="width: 10px;">Not Sale</th>
                        ...
                        <tbody>
                            <c:forEach items="${sessionScope.STUFF_DATA}" var="m">
                                <tr class="tr" style="text-align: center;">
                                    <td>
                                        <img src="./asset/image/${m.image}" alt="Default Image" style="width: 50px; height: 50px">
                                    </td>
                                    <td>${m.stuffId}</td>
                                    <td>${m.stuffName}</td>                         
                                    <td>${m.price}</td>
                                    ...
                                    <td>
                                        <a href="#editEmployeeModal" class="edit" data-toggle="modal"
                                           data-update-stuff-id="${m.stuffId}"
                                           data-update-stuff-description="${m.description}"
                                           data-update-stuff-price="${m.price}"
                                           data-update-stuff-quantity="${m.quantity}"
                                           data-update-stuff-notsale="${m.notSale}"
                                           >
                                            <i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i>
                                        </a>
                                        <a href="#deleteEmployeeModal" class="delete" data-toggle="modal" data-stuff-id="${m.stuffId}"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                                    </td>
                                </tr>
                            </c:forEach>
                        </tbody>
        ...
        <div id="addEmployeeModal" class="modal fade">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="ADDStuffServlet" method="POST" enctype="multipart/form-data">
                        <div class="modal-header">						
                            <h4 style="color: #564846;" class="modal-title">Add Stuff</h4>
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                        </div>
                        <div class="modal-body">	
                            <div class="form-group">
                                <label>Stuff Id</label>
                                <input type="text" class="form-control" required name="stuffId">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" required name="stuffName">
                            </div>
                            <div class="form-group">
                        ...
                        <div class="modal-footer">
                            <input style="border: #44709d solid 2px; color: #44709d;" type="button" class="btn btn-cancel" data-dismiss="modal" value="Cancel">
                            <input style="color: white; background-color: #44709d;" type="submit" class="btn btn-add" value="AddStuff" name="action">
                        </div>
                    </form>
                </div>
            </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="MainController" method="POST">
                        <input type="hidden" name="stuffId" value="" id="updateId"/>
                        <div class="modal-header">						
                            <h4 style="color: #564846;" class="modal-title">Edit Stuff</h4>
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                        </div>
                        <div class="modal-body">					
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label>Not Sale</label>
                                <input type="checkbox" class="" name="notSale" id="stuffNotSale">
                            </div>
                        </div>
                        <div class="modal-footer">
                            <input style="border: #44709d solid 2px; color: #44709d;" type="button" class="btn btn-cancel" data-dismiss="modal" value="Cancel">
                            <input  style="color: white; background-color: #44709d;" type="submit" class="btn btn-add" value="UpdateStuff" name="action">
                        </div>
                    </form>
                </div>
            </div>
        ...
        <div id="deleteEmployeeModal" class="modal fade">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="MainController" method="POST">
                        <div class="modal-header">						
                            <h4 class="modal-title">Delete Stuff</h4>
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                        </div>
                        ...
                        <!-- Other modal content... -->
                        <input type="hidden" id="stuffId" name="stuffId" value="">
                        <div class="modal-footer">
                            <input style="border: #44709d solid 2px; color: #44709d;" type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">
                            <input  style="color: white; background-color: #44709d;" type="submit" class="btn btn-add" value="DeleteStuff" name="action">
                        </div>
                    </form>
                </div>
            </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            $('.delete').on('click', function () {
                var stuffId = $(this).data('stuff-id');
                $('#stuffId').val(stuffId);
            });
        });
        $(document).ready(function () {
