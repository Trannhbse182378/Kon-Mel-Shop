...
<html>
    ...
    <body>
        ...
        <div class="navbar">
            ...
            <a href="cart.jsp" id='viewcart' style="width: auto; height: 13px; font-size: 14px;">View Cart</a> 
        </div>
        ...
        <form action="MainController" method="POST">
            ...
            <div class="cart-list">
                <table class="table table-bordered">
                    <thead>
                        <tr>
                            <th class="product-counter">No</th>
                            <th class="product-thumbnail">Image</th>
                            <th class="product-name">Stuff</th>
                    ...
                    <tbody>
                        <c:forEach items="${sessionScope.CARTS}" var="cart" varStatus="status">
                            <tr>
                                ...
                                <td><img src="./image/${cart.image}" alt="Stuff Image" class="img-fluid"></td>
                                <td>${cart.stuffName}</td>
                                <td>${cart.price}</td>
                                <td>
                                    <div class="input-group mb-3" style="max-width: 120px;">
                                        ...
                                        <input style="margin-top:12px;outline: none !important;width: 40px;
                                               box-shadow: none !important;" name="quantity_${cart.stuffId}" type="text" class="form-control text-center" value="${cart.quantity}" placeholder="" aria-label="Quantity" aria-describedby="button-addon1">
                                ...
                                <td><a href="RemoveToCartServlet?stuffId=${cart.stuffId}" id="del-button" class="btn btn-primary btn-sm">X</a></td>
                            </tr>
                        </c:forEach>
                    </tbody>
                </table>
            ...
            <div class="below-table">
                <div class="container-table">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="row mb-5" id="update-continue">
                                <div class="col-md-6">
                                    <button id="update" class="btn btn-outline-primary btn-sm btn-block">UPDATE CART</button>
                                </div>
                                <div id="continue" class="col-md-6">
                                    <!--<button class="btn btn-outline-primary btn-sm btn-block">CONTINUE SHOPPING</button>-->
                                    <a href="home.jsp" class="btn btn-outline-primary btn-sm btn-block update-link">CONTINUE SHOPPING</a>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <label id="coupon-title" class="text-black h4" for="coupon" style="color: #564846;">Coupon</label>
                                    <p style="color: gray; font-size: 15px;">Enter your coupon code if you have one.</p>
                                </div>
                                <div class="col-md-8 mb-3 mb-md-0">
                                    <input style="color: #564846;" type="text" class="form-control py-3" id="coupon">
                                </div>
                                <div class="col-md-4">
                                    <button type="button" id="apply" class="btn btn-outline-primary btn-sm btn-block">APPLY COUPON</button>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 pl-5">
                            <div class="row justify-content-end">
                                <div class="col-md-7" >
                                    <div class="row">
                                        <div class="col-md-12 text-center border-bottom mb-5" style="color: #564846;">
                                            <h3 class="text-black h4" >CART TOTAL</h3>
                                        </div>
                                    </div>
                                    <div class="row mb-3" style="color: #564846;">
                                        <div class="col-md-6">
                                            <span class="text-black">Subtotal</span>
                                        </div>
                                        <div class="col-md-6 text-right" >
                                            <strong class="text-black" id="cartSubtotal">0</strong> <!-- Subtotal -->
                                        </div>
                                    </div>
                                    <div class="row mb-5" style="color: #564846;">
                                        <div class="col-md-6">
                                            <span class="text-black">Total</span>
                                        </div>
                                        <div class="col-md-6 text-right">
                                            <strong class="text-black" id="cartTotal">0</strong> <!-- Total -->
                                        </div>
                                    </div>

                                    <div class="row">
                                        <div class="col-md-12">
                                            <a href="checkout.jsp" id="checkout" class="btn btn-primary btn-lg py-3 btn-block">Proceed To Checkout</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
