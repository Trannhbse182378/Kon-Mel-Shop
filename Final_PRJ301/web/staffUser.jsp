    ...
    <head>
        ...
        <style>
            ...
            *{
            ...
            .btn-stuff:hover,  .btn-order:hover{
                border: white solid 2px;
                color: #44709d;
                background-color: white;
            }
        ...
        <div class="header-container">
            <div class="luxury-form-container">
                <form action="MainController" method="GET" class="luxury-form" style="position: absolute; top: 19px; left: 73px;">
                    <input type="hidden" name="action" value="SearchAndRedirectUser">
                    <div style="position: relative;">
                        ...
                        <input type="text" name="searchUser" placeholder="Search by user id" class="luxury-input" style="padding-left: 40px;">
                    </div>
            ...
            <div class="table-responsive">
                <div class="table-wrapper">
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            <c:forEach items="${sessionScope.USER_LIST}" var="m">
                                <c:set var="counter" value="${counter + 1}"/>
                                <tr class="tr" style="text-align: center;">
                                    <td>${counter}</td>
                                    <td>
                                        <c:choose>
                                            <c:when test="${m.role == 2}">
                                                Admin
                                            </c:when>
                                            <c:when test="${m.role == 0}">
                                                User
                                            </c:when>
                                            <c:otherwise>
                                                Unknown
