...
<html>
    ...
    <body>
        ...
        <div class="navbar">
            ...
            <a href="checkout.jsp" id='viewcart' style="width: auto; height: 13px; font-size: 14px;">Check Out</a> 
        </div>

        <form action="MainController" method="POST">
            <input type="hidden" name="action" value="Order">
            <div class="below-table" style="margin-top: 50px; margin-bottom: -10px;">
                <div class="container-table">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="row" >
                                <div class="col-md-12 text-center border-bottom mb-5" style="color: #564846;">
                                    <h3 class="text-black h4" >DELIVERY INFORMATION</h3>
                                </div>
                            </div>
                            <div class="row" style="color: #564846;">
                                <div class="col-md-12">
                                    <form style="width: 102%;">
                                        <div class="form-group" style="margin-bottom: 40px; margin-top: 10px;">
                                            <input type="tel" class="form-control" name="addressInput" placeholder="Enter address" required>
                                        </div>
                                        <div class="form-group">
                                            <input type="tel" class="form-control" name="phoneInput" placeholder="Enter phone number" required>
                                        </div>
                                        <div class="form-group">
                                            <input type="hidden" name="totalInput"required>
                                        </div>
                                    </form>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6" >
                            <div class="row justify-content-end">
                                <div class="col-md-7" >
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <button type ="submit" id="checkout" class="btn btn-primary btn-lg py-3 btn-block">ORDER</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <tbody class="tbody">
                        <c:forEach items="${sessionScope.CARTS}" var="cart" varStatus="status">
                            <tr>
                                ...
                                <td><img style="width: 70px;" src="./image/${cart.image}" alt="Stuff Image" class="img-fluid"></td>
    ...
    <script>
                    function updateTotal() {
                        ...
                        var formattedSubtotal = Math.floor(subtotal).toFixed(0); // Giả sử bạn muốn giá trị không có phần thập phân
                        document.getElementById('cartSubtotal').textContent = formattedSubtotal + " VND";
                        document.getElementById('cartTotal').textContent = formattedSubtotal + " VND";

                        // Cập nhật giá trị cho input có name="totalInput"
                        document.querySelector('input[name="totalInput"]').value = formattedSubtotal;
                    }

// Đảm bảo rằng hàm updateTotal được gọi khi trang tải xong hoặc khi có sự thay đổi trong giỏ hàng
