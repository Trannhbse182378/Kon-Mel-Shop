...
/*            div {
            ...
            .container-sample {
                ...
                margin: 19px 10px 50px 50px; /* Khoảng cách từ top */
            }
    ...
    <body>
        ...
        <div class="navbar-menu" style="background-color: white;">
            ...
            <div class="stuff-type">
                <a href="category.jsp">STUFF CATEGORY</a>
        ...
        <div class="rowTitle">
            ...
            <h3 class="section-title" style="color: #44709d;">♡ CUTE STUFFED ANIMAL ♡</h3>
            <div class="custom-button-container">
                <a href="category.jsp" class="custom-button show-more-button">SHOW MORE</a>
            </div>
        ...
        <!-- The Modal --> <!--BẢNG NÀY LÀ BẢNG HIỆN THỊ INFO KHI TA CLICK VÀO HÌNH -->
    ...
    <script>
                            var tmp = '${requestScope.POSITIVE_NUMBER_ERROR}';
